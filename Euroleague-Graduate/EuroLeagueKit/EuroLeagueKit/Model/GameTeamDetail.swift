...
public class GameTeamDetail: Object {
    //V5
    ...
    public var playersStats = List<GamePlayerStats>()
...
public extension GameTeamDetail {

    public func clone() -> GameTeamDetail {
    ...
    public func getQuarter(ofRow row: Int) -> Int {
        switch row {
        case 0:
            return partial1
        case 1:
